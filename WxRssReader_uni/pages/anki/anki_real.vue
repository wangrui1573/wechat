<template>
  ...
  <text class="meaning" wx:if="{{ showMeaning }}">{{ currentWord.meaning }}</text>
        ...
        <view class="lower-status">
            ...
            <navigator url="/pages/anki/anki_dri_real" open-type="redirect">
...
export default {
    ...
    methods: {
        ...
        initializeData: function (initialWords) {
            uni.setStorageSync('words_real', initialWords);
            this.setData({
                words: initialWords
            });
            this.nextWord();
        ...
        loadStoredData: function () {
            const localWords = uni.getStorageSync('words_real') || [];
            return localWords;
        },

        saveStoredData: function (updatedWords) {
            uni.setStorageSync('words_real', updatedWords);
            this.setData({
                words: updatedWords
            });
        },
        ...
        resetStatus: function () {
            ...
            uni.setStorageSync('words_real', updatedWords); // 将更新后的数据直接覆盖到本地存储
